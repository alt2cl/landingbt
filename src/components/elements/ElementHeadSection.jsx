  ...
  return (
      <React.Fragment>
        <div className="head-section-call d-flex align-items-center">
            <img className="icon-head" src="assets/img/icons/cat_coches.svg" alt="crib"/>
            ...
            <span>Coches</span>
            <small>+920 productos en oferta</small></h5>
            <a className="btn btn-primary btn-lg ml-auto pink-btn" href="/">Ver todo</a>
        </div>
      </React.Fragment>
